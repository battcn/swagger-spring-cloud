  ...
  <div class="bycdao-main">
    ...
    <div v-show="switchA==1" class="debugging-content">
      <div class="content-url">
        ...
        <div>
          <input v-bind:value="(bycdaoCategory[0]&&bycdaoCategory[0][0])?bycdaoCategory[0][0]:''" style="width:100%;height: 23px;line-height: 23px;" type="text"/>
        </div>
      ...
      <div class="content-parameter" v-if="bycdaoCategory[countTo]&&bycdaoCategory[countTo][2].parameters">
        <ul>
          ...
          <li v-for="(item,index) in bycdaoCategory[countTo][2].parameters">
            <input  style="margin-top:10px;" class="parameter-checkbox" type="checkbox" :checked="item.required==true"  />
      ...
      <div class="debugging-result">
        <span style="cursor:pointer;" @click="debugging='content'" :class="[debugging=='content'?'active':'']">响应内容</span>
        <span style="cursor:pointer;" @click="debugging='cookies'" :class="[debugging=='cookies'?'active':'']">Cookies</span>
        <span style="cursor:pointer;" @click="debugging='header'" :class="[debugging=='header'?'active':'']">Header</span>
...
<script type="text/ecmascript-6">
  ...
  export default {
    name: "app",
    data() {
      return {switchA: 0,debugging:'content'}
    },
    methods: {
      getForm:function(){
...
font-size: 0;
  ...
  .result-content{
border-top: 1px solid #EBEBEB;padding-top: 40px;
  }
  /* 请求参数表格 */
  .table-tr {
